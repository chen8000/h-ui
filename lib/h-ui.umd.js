...
var Pagination_src_component = normalizeComponent(
  ...
  srcvue_type_template_id_38572559_render,
  srcvue_type_template_id_38572559_staticRenderFns,
  false,
  null,
  null,
  null
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"024047b1-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./packages/components/Audio/src/index.vue?vue&type=template&id=e452b5a6&
var srcvue_type_template_id_e452b5a6_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"h--audio-box"},[_c('audio',{directives:[{name:"show",rawName:"v-show",value:(true),expression:"true"}],ref:"audio",attrs:{"src":_vm.src},on:{"loadedmetadata":_vm.getTimeTotal,"timeupdate":_vm.audioTimeUpDate,"error":_vm.loadError,"ended":_vm.handleEnd}}),_c('div',{staticClass:"audio-container"},[_c('div',{staticClass:"btn-group",on:{"mouseover":_vm.playOver,"mouseleave":_vm.playLeave}},[(!_vm.playStatus)?_c('i',{staticClass:"iconfont iconbofang",on:{"click":_vm.handlePlay}}):_vm._e(),(_vm.playStatus)?_c('i',{staticClass:"iconfont iconzantingtingzhi",on:{"click":_vm.handlePause}}):_vm._e()]),_c('p',{staticClass:"currentTime"},[_vm._v(_vm._s(_vm.currentTimes)+"/"+_vm._s(_vm.total))]),_c('el-slider',{ref:"slider",staticClass:"ele-progress",attrs:{"format-tooltip":_vm.formatTooltip},on:{"input":_vm.progressChange},model:{value:(_vm.progress),callback:function ($$v) {_vm.progress=$$v},expression:"progress"}}),_c('div',{staticClass:"sound",on:{"mouseover":_vm.soundOver,"mouseleave":_vm.soundLeave}},[_c('div',{directives:[{name:"show",rawName:"v-show",value:(_vm.soundClass),expression:"soundClass"}],staticClass:"sound-box"},[_c('el-slider',{attrs:{"vertical":"","show-tooltip":false},on:{"input":_vm.soundChange},model:{value:(_vm.sound),callback:function ($$v) {_vm.sound=$$v},expression:"sound"}})],1),(_vm.resSound > 0.0)?_c('i',{staticClass:"iconfont iconjingyin1"}):_vm._e(),(_vm.resSound === '0.0')?_c('i',{staticClass:"iconfont iconjingyin"}):_vm._e()])],1)])}
var srcvue_type_template_id_e452b5a6_staticRenderFns = []


// CONCATENATED MODULE: ./packages/components/Audio/src/index.vue?vue&type=template&id=e452b5a6&
...
/* harmony default export */ var Audio_srcvue_type_script_lang_js_ = ({
  ...
  methods: {
    addEvent: function addEvent() {
      ...
      this.$refs.slider.$el.addEventListener('mouseup', function () {
        setTimeout(function () {
          _this.progressType = false;
        }, 500);
      });
    },
    // 播放
...
var Audio_src_component = normalizeComponent(
  ...
  srcvue_type_template_id_e452b5a6_render,
  srcvue_type_template_id_e452b5a6_staticRenderFns,
  false,
  null,
  null,
  null
...
var components = [Button, Table, Pagination, Audio]; // 定义install 方法，接收 Vue 作为参数，如果使用 use 注册插件，那么所有组件都会被注册
